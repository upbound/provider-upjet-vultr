...
func main() {
	...
	kingpin.FatalIfError(clusterapis.AddToScheme(scheme), "Cannot add cluster-scoped Vultr APIs to scheme")
	kingpin.FatalIfError(namespacedapis.AddToScheme(scheme), "Cannot add namespaced Vultr APIs to scheme")
