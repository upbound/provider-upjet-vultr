...
type DatabaseInitParameters struct {
	...
	AccessCertSecretRef *v2.LocalSecretKeySelector `json:"accessCertSecretRef,omitempty" tf:"-"`
	...
	FerretdbCredentials map[string]string `json:"ferretdbCredentialsSecretRef,omitempty" tf:"-"`
	...
	MySQLLongQueryTime *int64 `json:"mysqlLongQueryTime,omitempty" tf:"mysql_long_query_time,omitempty"`
	...
	PlanBrokers *int64 `json:"planBrokers,omitempty" tf:"plan_brokers,omitempty"`

	// The description of the disk(s) on the managed database.
	PlanDisk *int64 `json:"planDisk,omitempty" tf:"plan_disk,omitempty"`

	// The number of standby nodes available on the managed database (excluded for Kafka engine types).
	PlanReplicas *int64 `json:"planReplicas,omitempty" tf:"plan_replicas,omitempty"`
...
type DatabaseObservation struct {
	...
	PendingCharges *float64 `json:"pendingCharges,omitempty" tf:"pending_charges,omitempty"`
	...
	PlanRAM *int64 `json:"planRam,omitempty" tf:"plan_ram,omitempty"`

	// The number of standby nodes available on the managed database (excluded for Kafka engine types).
	PlanReplicas *int64 `json:"planReplicas,omitempty" tf:"plan_replicas,omitempty"`

	// The number of virtual CPUs available on the managed database.
	PlanVcpus *int64 `json:"planVcpus,omitempty" tf:"plan_vcpus,omitempty"`
...
type DatabaseParameters struct {
	...
	// +kubebuilder:validation:Optional
	FerretdbCredentialsSecretRef *v2.LocalSecretReference `json:"ferretdbCredentialsSecretRef,omitempty" tf:"-"`
