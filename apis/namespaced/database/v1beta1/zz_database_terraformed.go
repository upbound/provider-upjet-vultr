...
func (tr *Database) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"access_cert": "accessCertSecretRef", "access_key": "accessKeySecretRef", "ferretdb_credentials": "ferretdbCredentialsSecretRef", "password": "passwordSecretRef", "read_replicas[*].ferretdb_credentials": "readReplicas[*].ferretdbCredentialsSecretRef", "read_replicas[*].password": "status.atProvider.readReplicas[*].password"}
}
