...
func (mg *OrganizationPolicy) GetTerraformResourceType() string {
	return "vultr_organization_policy"
}
...
func (tr *OrganizationPolicy) GetObservation() (map[string]any, error) {
...
func (tr *OrganizationPolicy) SetObservation(obs map[string]any) error {
...
func (tr *OrganizationPolicy) GetParameters() (map[string]any, error) {
...
func (tr *OrganizationPolicy) SetParameters(params map[string]any) error {
...
// GetInitParameters of this OrganizationPolicy
func (tr *OrganizationPolicy) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this OrganizationPolicy
func (tr *OrganizationPolicy) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
