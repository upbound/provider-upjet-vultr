...
func (mg *ConnectionPool) ResolveReferences( // ResolveReferences of this ConnectionPool.
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("database.vultr.upbound.io", "v1beta1", "DB", "DBList")
		if err != nil {
	...
	{
		m, l, err = apisresolver.GetManagedResource("database.vultr.upbound.io", "v1beta1", "Database", "DatabaseList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
	...
	{
		m, l, err = apisresolver.GetManagedResource("database.vultr.upbound.io", "v1beta1", "User", "UserList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
