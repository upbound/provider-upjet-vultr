...
type DatabaseInitParameters struct {
	...
	AccessCertSecretRef *v2.SecretKeySelector `json:"accessCertSecretRef,omitempty" tf:"-"`
...
type DatabaseParameters struct {
	...
	// +kubebuilder:validation:Optional
	FerretdbCredentialsSecretRef *v2.SecretReference `json:"ferretdbCredentialsSecretRef,omitempty" tf:"-"`
