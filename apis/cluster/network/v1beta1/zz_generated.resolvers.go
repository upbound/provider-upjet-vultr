...
func (mg *DNSRecord) ResolveReferences( // ResolveReferences of this DNSRecord.
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("network.vultr.upbound.io", "v1beta1", "DNSDomain", "DNSDomainList")
		if err != nil {
...
func (mg *NATGatewayFirewallRule) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("network.vultr.upbound.io", "v1beta1", "NATGateway", "NATGatewayList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
