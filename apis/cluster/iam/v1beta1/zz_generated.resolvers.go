...
func (mg *OIDCIssuer) ResolveReferences( // ResolveReferences of this OIDCIssuer.
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("vke.vultr.upbound.io", "v1beta1", "Kubernetes", "KubernetesList")
		if err != nil {
...
func (mg *OrganizationPolicyGroupAttachment) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("iam.vultr.upbound.io", "v1beta1", "OrganizationGroup", "OrganizationGroupList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
	...
	{
		m, l, err = apisresolver.GetManagedResource("iam.vultr.upbound.io", "v1beta1", "OrganizationPolicy", "OrganizationPolicyList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
...
func (mg *OrganizationPolicyUserAttachment) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	mg.Spec.ForProvider.PolicyIDRef = rsp.ResolvedReference
	{
		m, l, err = apisresolver.GetManagedResource("iam.vultr.upbound.io", "v1beta1", "User", "UserList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
...
func (mg *OrganizationRoleGroupAttachment) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	mg.Spec.ForProvider.GroupIDRef = rsp.ResolvedReference
	{
		m, l, err = apisresolver.GetManagedResource("iam.vultr.upbound.io", "v1beta1", "OrganizationRole", "OrganizationRoleList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
